...
st.subheader("U.S. 10Y Yield Decomposition")
...
with mom_left:
    st.subheader("🇺🇸 U.S. Momentum")

    if not us_momentum_rows:
        st.warning("미국 Macro Momentum을 계산할 데이터가 부족합니다.")
    else:
        st.dataframe(
